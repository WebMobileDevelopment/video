            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    @if(in_array($data->redeem_request_status ,[REDEEM_REQUEST_SENT , REDEEM_REQUEST_PROCESSING]))
                        ...
                        @if($data->user_details->paypal_email)
                            ...
                            <form action="{{Setting::get('redeem_paypal_url')}}" method="post">
                                ...
                                <input name = "business" value = "{{$data->user_details ? $data->user_details->paypal_email : ''}}" type = "hidden">
                        ...
                        <p class="text-muted">{{tr('user_no_paypal_email')}}</p>
