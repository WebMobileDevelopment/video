<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <form  action="{{ Setting::get('admin_delete_control') == YES ? '#' : route('admin.video-ads-details.save')}}" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="col-md-12 form-group" style="margin-top: 10px;">
                    	...
                    	<div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="file" name="file" id="file" accept="" onchange="loadFile(this, 'ad_preview')" @if(!$ads_detail_details->id) required @endif>
