                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($video->video_type == VIDEO_TYPE_R4D) 
                    ...
                    <tr>
                        <th>Resources</th>
                        <td>
                            Folders: {{get_folder_count($video->video_tape_id, 'admin')}}, Videos: {{get_video_files_count($video->video_tape_id, 'admin')}}
                        </td>
                    </tr>
                    @endif
                    ...
                    <tr>
                        <th>{{tr('age_limit')}}</th>
                        <td>{{($video->age_limit == 100) ? 'All Users' :  $video->age_limit.'+'}}</td>
                    </tr>
